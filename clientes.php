...
$resultadoCliente = $clasesql->ConsultaClientesG();
...
<hr>
        <div>
          <table class="table table-striped table-hover" id="DtableCliente">
            <thead>
                <tr>
                    <th> Cédula </th>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ingrese Clientes</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="guardarcliente.php" name="form1" method="POST" class="needs-validation" novalidate>
...
<div class="container">
      <hr>
        ...
        <a class="btn btn-danger" href="reportes/clientespdf.php"><h6>Reporte Pdf</h6></a>
